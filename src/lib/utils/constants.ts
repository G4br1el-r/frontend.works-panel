...
export const APP_SIDEBAR_NAV_GROUPS = [
  {
    title: "Geral",
    items: [
      {
      ...
      {
        title: "Orçamentos",
        href: "/gestao-obras/orcamentos",
        icon: FileText,
        badge: 3,
      },
      {
        title: "Calendário",
        href: "/gestao-obras/calendario",
        icon: Calendar,
        badge: undefined,
      },
      {
        title: "Financeiro",
        href: "/gestao-obras/financeiro",
        icon: Wallet,
        badge: undefined,
      },
    ],
