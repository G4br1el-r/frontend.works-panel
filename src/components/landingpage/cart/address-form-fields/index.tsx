...
export interface AddressFormBundle {
  form: UseFormReturn<
    AddressRegisterFormData,
    unknown,
    AddressRegisterFormOutput
...
type AddressFormFieldsProps = AddressFormBundle & {
  formId: string;
};
...
export function AddressFormFields({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor={`${formId}-cep`} className={FIELD_LABEL_CLASSNAME}>
          CEP DA OBRA
        </label>
        <Controller
          control={control}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex flex-col gap-1.5">
          <label htmlFor={`${formId}-state`} className={FIELD_LABEL_CLASSNAME}>
            UF
          </label>
          <input
            id={`${formId}-state`}
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor={`${formId}-city`} className={FIELD_LABEL_CLASSNAME}>
            CIDADE
          </label>
          <input
            id={`${formId}-city`}
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="col-span-2 flex flex-col gap-1.5">
          <label htmlFor={`${formId}-street`} className={FIELD_LABEL_CLASSNAME}>
            RUA
          </label>
          <input
            id={`${formId}-street`}
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor={`${formId}-number`} className={FIELD_LABEL_CLASSNAME}>
            NÚMERO
          </label>
          <input
            id={`${formId}-number`}
