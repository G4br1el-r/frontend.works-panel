...
import { useEditAddress } from "@/hooks/landingpage/cart/use-edit-address";

const EDIT_ADDRESS_FORM_ID = "edit-address-form";
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="flex-row shrink-0 items-start justify-between gap-4 space-y-0 border-b border-white/10 p-4 sm:p-6">
          <div className="flex flex-col gap-1.5">
            ...
            <SheetDescription className="text-sm text-neutral-400">
              Atualize os dados desse endereço.
            </SheetDescription>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          <AddressFormFields {...addressForm} formId={EDIT_ADDRESS_FORM_ID} />
        </div>

        <SheetFooter className="mt-0 shrink-0 border-t border-white/10 p-3">
          <button
            form={EDIT_ADDRESS_FORM_ID}
            type="submit"
