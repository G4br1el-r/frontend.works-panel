...
import { METRICS_ANIMATION_DELAY, METRICS_ITEMS, NOTCHED_CARD_CLIP_PATH } from "@/utils/constants";
  ...
  return (
    ...
    >
      {METRICS_ITEMS.map((metric, index) => (
        <StaggerItem key={metric.id} as="li" direction="up" distance={20} duration={0.6}>
          <div
